...
if __name__ == "__main__":
    invoice1 = Invoice("INV001", "RES001", "G001", "2023-05-01", "2023-05-15", 500.00)
    invoice1.add_line_item("Room Service", 50.00)
    print(invoice1)
    invoice1.record_payment(200.00)
    print(invoice1)
    invoice1.record_payment(300.00)
    print(invoice1)

    invoice_data = invoice1.to_dict()
    print(invoice_data)

    invoice2 = Invoice.from_dict(invoice_data)
    print(invoice2) 